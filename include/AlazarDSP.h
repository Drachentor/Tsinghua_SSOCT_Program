 ...
 *
 * @warning This function is intended to be used for log U8 and log U16 outputs.
 Using it with other FFT outputs will result in undefined behaviors.
 *
...
enum DSP_PARAMETERS_U32 {
    ...
    DSP_FFT_SUBTRACTOR_SUPPORTED,   ///< Tells if an FFT module supports
                                    ...
                                    /// and \c 1 if it is.
    DSP_FFT_GAIN_OFFSET_SUPPORTED,  ///< Tells if an FFT module supports
